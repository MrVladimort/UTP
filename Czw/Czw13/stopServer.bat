...
"%JAVA_HOME%\bin\java" -Dderby.system.home=E:\Workspace\IntelliJIDEA\UTP\Czw\Czw13\DerbyDbs -cp "%DERBY_JARS%" org.apache.derby.drda.NetworkServerControl shutdown 
